   ...
   function(
    ...
    Popover
        ...
        return declare([WidgetBase, TemplatedMixin], {
		   ...
		   displayHabitatResults: function() {
		   
		   //You need to just keep this all in the same file.
		   
		   functional.forIn(this.resultSet, lang.hitch(this,function(outp,pname){
