...
define([
	...
	"dojo/text!./templates/SummarizeByUnit.html", 
	"dojo/dom-style", 
	"dojo/dom-class", 
	"dojo/_base/fx", 
	"dojo/_base/lang", 
	...
	featureSelector: function(features, selectionMethod) {
		...
		//feats = this.featureLayer.getSelectedFeatures()
		   ...
		   getTable: function(jobInfo) {
			   ...
			   outputs = [{name:"LandCoverSummary",color:"#081",habtable:[]},{name:"WaterBirdSummary",color:"#018",habtable:["1","0.75","0.25","0"]},{name:"ShoreBirdSummary",color:"#F60",habtable:["1","0.5","0.25","0"]},{name:"LandBirdSummary",color:"#811",habtable:["1","0.5","0"]}]
		   ...
		   displayHabitatResults: function(results, color) {
			...
			lablearr = []
			  ...
			  dojo.forEach(results.habtable, function(val, j){ 
			  		
			  		i = results.habtable.length - j - 1
			  		inval = results.habtable[i]
			   ...
			   tnodes = query("#" + this.domNode.id + " ." + results.paramName + "HTable.totarea");
			   pnodes = query("#" + this.domNode.id + " ." + results.paramName + "HTable.poftotal");
			   cnodes = query("#" + this.domNode.id + " ." + results.paramName + "HTable.cpercent");
			   ppnodes = query("#" + this.domNode.id + " ." + results.paramName + "HTable.percentp");
