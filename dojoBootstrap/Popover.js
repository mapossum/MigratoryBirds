...
define([
    ...
    var Popover = declare(Tooltip, {
        ...
        setContent:function () {
            this.xclass = domAttr.get(this.domNode, "data-cus	tom-class");
            domClass.add(this.tipNode, this.xclass);
            var tip = this.tip();
        ...
        tip:function () {
        	...
        	//alert(classtoadd)
        	//domClass.add(this.tipNode, domAttr.get(this.domNode, "data-custom-class")); 
